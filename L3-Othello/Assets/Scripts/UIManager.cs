...
public class UIManager : MonoBehaviour
{
    ...
    public void SetPlayerText(Joueur courant, string getTypeAI)
    {
        if (courant == Joueur.Blanc)
        {
            topText.text = "Tour des Blancs " + getTypeAI + " <sprite name=DiscWhiteUp>";
        }
        else if (courant == Joueur.Noir)
        {
            topText.text = "Tour des Noirs " + getTypeAI + " <sprite name=DiscBlackUp>";
        }
    }
